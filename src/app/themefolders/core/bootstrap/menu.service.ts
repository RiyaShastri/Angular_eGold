...
export class MenuService {
  ...
  public _menuClose$ = new BehaviorSubject<any>(false);
  public depositorNameArr = new BehaviorSubject<any[]>([]);
  sharedArray$ = this.depositorNameArr.asObservable();

  //header menu close event
  getMenuValue(): Observable<any> {
    return this._menuClose$.asObservable();
  }

  // depositorNameArr
  updateSharedArray(newArray: any[]) {
    this.depositorNameArr.next(newArray);
  }
